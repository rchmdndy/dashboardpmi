...
<body onload="window.print()">
        ...
        <tbody>
            @foreach($records as $record)
                    <tr>
                        ...
                        <td>{{ $record->room_type->room_type }}</td>
    ...
    <h10>Perhatian :</h1>
    <p>Semua Keterangan Tercatat per-hari dimana Laporan Dibuat</p>
    <div class="signature">
