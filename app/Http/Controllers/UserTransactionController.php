...
class UserTransactionController extends Controller
{
    ...
    public function getUserTransaction(Request $request){
        ...
        $userTransactions = $userTransactions->map(function($userTransaction) use($formatter){
           $userTransaction->room_image = asset($userTransaction->booking->first()->room->roomType->room_image->first()->image_path);
    ...
    public function detail(Request $request){
        ...
        $data = array(
            ...
            'room_detail' => [
                ...
                'room_image' => asset($transaction->booking->first()->room->roomType->room_image->first()->image_path),
